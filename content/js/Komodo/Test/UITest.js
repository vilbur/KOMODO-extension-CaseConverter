...
var UI = function()
{
	return new ko.extensions.CaseConverter.Komodo.UI( ko.extensions.CaseConverter.Komodo.Document.get('pane')); 
}; 
...
{
	var values = UI().values('#CaseConverter-pane');
	console.log( values );
};
...
//ko.extensions.CaseConverter.test("TEST")
/*---------------------------------------
	RUN TESTS
-----------------------------------------
*/
