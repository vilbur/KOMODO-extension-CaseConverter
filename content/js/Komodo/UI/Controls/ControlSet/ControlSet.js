 ...
 * 
 */
ko.extensions.CaseConverter.Komodo.Controls.ControlSet = (function()
{
	function ControlSet()
	{
		var self	= this;		
		...
		this.load = function(containers_data)
		{
			...
			var createAdjustMenu = function()
			{
				...
				var command_add = [
					'var UI = CaseConverter().UI(document)',
		...
		{
			return new ko.extensions.CaseConverter.Komodo.Controls.Dropdown()
