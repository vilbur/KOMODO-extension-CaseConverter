 ...
 *
 */
ko.extensions.CaseConverter.UITest = {};
(function()
{
	function UITest()
	{
		...
		var prefs	= ko.extensions.CaseConverter.Komodo.Prefs.prefset('ui-test');
		var paneUI	= null;
		
		/** Test box selectors
		 */				
		var controls_box_id	= 'generated_examples';
		var main_element	= '';	// E.G.: '#CaseConverter-preferences'
		var controls_box	= ''; // final selector of test box element E.G.: '#CaseConverter-preferences #generated_example'
		...
		*/
		...
		this.Dopdown_ControlTest_dd = function()
		{
			...
			var dropdown_fn	= 'CaseConverter().UI(document).dropdown("#dropdown_test")';
		...
		*/
		...
		var setPaneUI = function(_document)
		{
			...
			paneUI = new ko.extensions.CaseConverter.Komodo.UI().document(_document);
...
})().apply(ko.extensions.CaseConverter.UITest);
...
function UITest()
{
	return ko.windowManager.getMainWindow().ko.extensions.CaseConverter.UITest;
}