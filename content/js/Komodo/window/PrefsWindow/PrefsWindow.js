...
(function()
{
	...
	{ 
		...
		this.init = function()
		{
			...
			var document_prefs	= CaseConverter().Komodo.Document.get('preferences');
			
			this.UI  = CaseConverter()._new('UI').document(document_prefs);
		...
		this.save = function()
		{
			...
			CaseConverter().Komodo.savePreferences('PrefsWindow');
		};
		/** Pref set
		 */
		...
		/** Template extension
		 * @return	ko.extensions.CaseConverter
		 */
...
})().apply(ko.extensions.CaseConverter.Komodo.PrefsWindow);


function PrefsWindow()
{
	return ko.windowManager.getMainWindow().ko.extensions.CaseConverter.Komodo.PrefsWindow;
}